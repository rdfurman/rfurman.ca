      ...
      >
        <InfoBox>
          ...
          <p>
            ...
            fridge, hot plate, microwave and coffee pot.
          </p>
          ...
          <p>
            ...
            pit, outside chairs & picnic table.
          </p>
          ...
          <h5>BYO Rooms</h5>
          <p>
            You will need to bring your own air mattress and bedding. There is a
            bathroom outside with toilets and pay showers, BBQ, and many fire
            pits & picnic tables for all BYO guests. The BYO rooms also have a
            large parking lot that can hold many RV's if they don't require hook
            ups.
          </p>
          <h6>XL BYO Rooms</h6>
          <p>
            The XL BYO room costs has 6 tables & chairs, heaters and enough
            space for 6 ppl to sleep.
          </p>
          <p>Price: $139.50/night. Extra guests are $20/night.</p>
          <h6>BYO Rooms</h6>
          <p>
            The smaller BYO rooms can hold 4 ppl. There is 1 queen size wood bed
            frame and you can accommodate 2 more in the same room if they setup
            a bed on the floor.{" "}
          </p>
          <p>Price: $86/night</p>
          ...
          <h5>Camping</h5>
          <p>
            There are RV camping sites available around each of the cabins that
            include full hookups. If your RV does not require any hookups we can
            squeeze in more units.
          </p>
